...
p_generalized = pressure_inhomogeneous_medium(P_left, P_right, P_up, P_down, h_x, h_y, mu, h, k_generalized)
...
u_x_generalized = velocity_x(k_generalized, mu, p_generalized, h_x) * 10^(-6)
u_y_generalized = velocity_y(k_generalized, mu, p_generalized, h_y) * 10^(-6)
...
c_generalized = concentration_2d(c_0_generalized, h_x, h_y, u_x_generalized, u_y_generalized, t)
#--------------------------------
